...
const PlanModel = ({ isOpen, onClose, faculty, }) => {
    ...
    return (
        <>
            <div className={`plan_modal ${isOpen ? 'show' : ''}`} onClick={onClose}>
                <div className="plan_modal_content" onClick={handleModalClick}>
                    <div className="plan_modal_header">
                        <span className="plan_modal_close" onClick={onClose}>&times;</span>
                    </div>
                    <div className="plan_model_form">
                        <div className="plan_model_title">
                            <h2>We are Hiring</h2>
