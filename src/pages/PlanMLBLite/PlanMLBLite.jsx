...
const PlanMLBLite = () => {
  ...
  const showPlanVideos = async () => {
    try {
      const response = await Paths.EndpointsURL.MLBLiteVideos;
  ...
  const showPlanCPlusBanner = async () => {
    try {
      const response = await Paths.EndpointsURL.PlanMLBLiteBanner;
      const record = await axios.get(response, {
        headers: {
          "Content-type": "application/json",
        },
  ...
  const showPlanCPlusOfferTab = async () => {
    try {
      const response = await Paths.EndpointsURL.MLBLiteKnowMorePrice;
      const record = await axios.get(response, {
        headers: {
          "Content-type": "application/json",
        },
