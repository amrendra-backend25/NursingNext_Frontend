...
const PlanMLBPro = () => {
  ...
  const showPlanVideos = async () => {
    try {
      const response = await Paths.EndpointsURL.MLBPROVideos;
  ...
  const showPlanStats = async () => {
    try {
      const response = await Paths.EndpointsURL.MLBPROStats;
      const record = await axios.get(response, {
        headers: {
          "Content-type": "application/json",
        },
  ...
  const showPlanSalient = async () => {
    try {
      const response = await Paths.EndpointsURL.MLBPROSalient;
      const record = await axios.get(response, {
        headers: {
          "Content-type": "application/json",
        },
  ...
  const showPlanCPlusBanner = async () => {
    try {
      const response = await Paths.EndpointsURL.PlanMLBPROBanner;
      const record = await axios.get(response, {
        headers: {
          "Content-type": "application/json",
        },
  ...
  const showPlanCPlusOfferTab = async () => {
    try {
      const response = await Paths.EndpointsURL.MLBPROKnowMorePrice;
      const record = await axios.get(response, {
        headers: {
          "Content-type": "application/json",
        },
  ...
  return (
    <>
      <section className="planmlb_section ">
        <Swiper
          spaceBetween={50}
          slidesPerView={1}
          navigation={{
        ...
        >
          {planCPlusBanner.slice(0, 1).map((banner) => {
            ...
            return (
              <>
                <SwiperSlide>
                  <div className="plan_mlb_img">
                    <img src={planImages} alt="" />
                    <div className="container">
                      <div className="planmlb_slider_title">
        ...
        <div className="container">
          ...
          <div className="refer_card_parent">
            ...
            <div className="refer_child_card">
              ...
              <div className="refer_title">
                <h5>Plan NP (NNL-VSL Pack)</h5>
                <p>
                  To Enhance Your Clinical, Behavioral & Leadership Skills with
                  Simulation Videos Under the Guidance of Trained Instructors!
                </p>
