...
const PlanNNLVSL = () => {
  ...
  // const showReferPlanCourses = async () => {
  //   try {
  //     const response = await Paths.EndpointsURL.CPlusReferCourses;
  //     const record = await axios.get(response, {
  //       headers: {
  //         "Content-type": "application/json",
  //       },
  ...
  //       setReferPlanCourses(referPlanCourses);
  ...
  return (
    <>
          ...
          <div className="plan_button_section_parent">
            <div className="plan_tab_button_left">
              <div className="plan_tab_img_left">
                {planCPlusTab.slice(1, 2).map((record) => {
                  const {
                    planTabHeading,
                    planTabSubHeading,
                    planTabParagraph,
      ...
      <section className="refer_section">
        <div className="container">
          ...
          <div className="refer_card_parent">
            {referPlanCourses.slice(0, 2).map((refer) => {
              const { referTitle, referSubTitle, referParagraph, referIcon } =
                refer;
              return (
                <>
      ...
      <section className="comingsoon_section">
        <div className="container">
          <div className="comingsoon_title">
            <img src={coming} alt="" />
          </div>
        </div>
      </section>
